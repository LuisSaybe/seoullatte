...
export default function Hangul() {
  ...
  return (
    <DefaultLayout>
      ...
      <Section className={styles.consonants}>
        {[
          ["ㄱ", "기역", "69070"],
          ["ㄲ", "쌍기역", "69072"],
          ["ㄴ", "니은", "24397"],
          ...
          <div key={index}>
            <span className={`${styles.character} ${styles.consonant}`}>
              {character}
            </span>
            <DefinitionPopup q={q} className={`${styles.character}`}>
              {name}
            </DefinitionPopup>
          </div>
        ))}
      ...
      <Section className={styles.vowels}>
        {[
          ["ㅏ", "68847"],
          ["ㅓ", "68854"],
          ["ㅗ", "68872"],
          ...
          <DefinitionPopup q={q} key={q} className={styles.character}>
            {character}
          </DefinitionPopup>
        ))}
      </Section>
